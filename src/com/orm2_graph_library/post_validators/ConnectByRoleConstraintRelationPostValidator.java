...
public class ConnectByRoleConstraintRelationPostValidator extends PostValidator {
    ...
    protected void validate() {
        ...
        ArrayList<RoleConstraintRelationEdge> connectedEdges = this._constraint.getIncidentElements(RoleConstraintRelationEdge.class).collect(Collectors.toCollection(ArrayList::new));
