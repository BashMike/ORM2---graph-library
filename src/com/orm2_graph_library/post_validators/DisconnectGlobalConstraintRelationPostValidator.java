...
public class DisconnectGlobalConstraintRelationPostValidator extends PostValidator {
    final private Constraint _constraint;
    final private Edge       _edge;

    public DisconnectGlobalConstraintRelationPostValidator(@NotNull Diagram diagram,
