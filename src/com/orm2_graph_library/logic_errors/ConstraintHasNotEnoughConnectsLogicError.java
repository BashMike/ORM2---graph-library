...
public class ConstraintHasNotEnoughConnectsLogicError extends LogicError {
    final private Constraint _constraint;
    final private ArrayList<Edge> _connectedConstraintRelationEdges = new ArrayList<>();

    public ConstraintHasNotEnoughConnectsLogicError(@NotNull Constraint constraint,
    ...
    public String description() {
        String result = "Constraint \"" + this._constraint.getClass() + "\" has only ";
