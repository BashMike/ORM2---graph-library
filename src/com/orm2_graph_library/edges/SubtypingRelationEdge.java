...
public class SubtypingRelationEdge extends Edge<EntityType, EntityType> {
    // ================ ATTRIBUTES ================
    private boolean _isInheritPathForRefMode;
    ...
    protected void _initSelf() {
        ...
        this._isInheritPathForRefMode = true;
    }
    ...
    public void beNotInheritPathForRefMode() { this._ownerDiagramActionManager().executeAction(new BecomeNotInheritPathForRefModeAction(this._ownerDiagram, this)); }
    ...
    // TODO - @check :: Possible action errors.
    public class BecomeNotInheritPathForRefModeAction extends Action {
        final private SubtypingRelationEdge            _edge;
        private SubtypingRelationEdge                  _oldInheritPath = null;
        final private ArrayList<SubtypingRelationEdge> _allEdges;

        private BecomeNotInheritPathForRefModeAction(Diagram diagram, @NotNull SubtypingRelationEdge edge) {
            super(diagram);
            this._edge = edge;
            this._allEdges = this._edge.begin().getIncidentElements(SubtypingRelationEdge.class)
                    .filter(e -> e.begin() == this._edge.begin()).collect(Collectors.toCollection(ArrayList::new));
        ...
        @Override
        public void _execute() {
            this._edge._isInheritPathForRefMode = false;
        }
